...
vector<int>  parameterP(GF2mat P[], int m){//m is the size of P
  ...
  cout<<P[0].rows()<<"\t"<<P[0].cols()<<endl;
  cout<<P[0].rows()*P[1].rows()<<"\t"<<P[0].rows()*P[1].cols()+P[0].rows()*P[1].cols()<<"\t"<<P[0].cols()*P[1].cols()<<endl;
  cout<<P[0].rows()*P[1].rows()*P[2].rows()<<"\t"
      <<P[0].rows()*P[1].cols()*P[2].rows()+P[0].rows()*P[1].cols()*P[2].rows()+P[0].rows()*P[1].rows()*P[2].cols()<<"\t"
      <<P[0].rows()*P[1].cols()*P[2].cols()+P[0].cols()*P[1].rows()*P[2].cols()+P[0].cols()*P[1].cols()*P[2].rows()<<"\t"
      <<P[0].cols()*P[1].cols()*P[2].cols()<<endl;
  cout<<P[0].rows()*P[1].rows()*P[2].rows()*P[3].rows()<<"\t"
      <<P[0].rows()*P[1].cols()*P[2].rows()*P[3].rows()+P[0].rows()*P[1].cols()*P[2].rows()*P[3].rows()+P[0].rows()*P[1].rows()*P[2].cols()*P[3].rows()+P[0].rows()*P[1].rows()*P[2].rows()*P[3].cols()<<"\t"
      <<P[0].rows()*P[1].rows()*P[2].cols()*P[3].cols()
    +P[0].rows()*P[1].cols()*P[2].rows()*P[3].cols()+P[0].cols()*P[1].rows()*P[2].rows()*P[3].cols()
    +P[0].rows()*P[1].cols()*P[2].cols()*P[3].rows()+P[0].cols()*P[1].rows()*P[2].cols()*P[3].rows()+P[0].cols()*P[1].cols()*P[2].rows()*P[3].rows()<<"\t"
      <<P[0].rows()*P[1].cols()*P[2].cols()*P[3].cols()+P[0].cols()*P[1].rows()*P[2].cols()*P[3].cols()+P[0].cols()*P[1].cols()*P[2].rows()*P[3].cols()+P[0].cols()*P[1].cols()*P[2].cols()*P[3].rows()<<"\t"
      <<P[0].cols()*P[1].cols()*P[2].cols()*P[3].cols()<<endl;
  */
  int n[m+1][MAX_M];
  n[1][0]=P[0].rows();
  n[1][1]=P[0].cols();
  ...
  cout<<kt[0]<<"\t"<<k[0]<<endl;
  cout<<kt[0]*kt[1]<<"\t"<<kt[0]*k[1]+k[0]*kt[1]<<"\t"<<k[0]*k[1]<<endl;
  cout<<kt[0]*kt[1]*kt[2]<<"\t"
      <<k[0]*kt[1]*kt[2]+kt[0]*k[1]*kt[2]+kt[0]*kt[1]*k[2]<<"\t"
      <<k[0]*k[1]*kt[2]+kt[0]*k[1]*k[2]+k[0]*kt[1]*k[2]<<"\t"
      <<k[0]*k[1]*k[2]<<endl;
  cout<<kt[0]*kt[1]*kt[2]*kt[3]<<"\t"
      <<k[0]*kt[1]*kt[2]*kt[3]+    kt[0]*k[1]*kt[2]*kt[3]+    kt[0]*kt[1]*k[2]*kt[3]+    kt[0]*kt[1]*kt[2]*k[3]<<"\t"
      <<    k[0]*k[1]*kt[2]*kt[3]+    k[0]*kt[1]*k[2]*kt[3]+    k[0]*kt[1]*kt[2]*k[3]
    +    kt[0]*k[1]*k[2]*kt[3]+    kt[0]*k[1]*kt[2]*k[3]+    kt[0]*kt[1]*k[2]*k[3]<<"\t"
      <<k[0]*k[1]*k[2]*kt[3]+k[0]*k[1]*kt[2]*k[3]+k[0]*kt[1]*k[2]*k[3]+kt[0]*k[1]*k[2]*k[3]<<"\t"
      <<k[0]*k[1]*k[2]*k[3]<<endl;
  */
  ...
  d[1][0]= (kt[0]>0)?1:999;
  d[1][1]=delta[1-1];
  d[2][0]=(kt[1]>0)?d[1][0]:999;
  d[2][1]= kt[2-1]>0 ? min(d[1][1],delta[2-1]*d[1][0]) :d[1][0]*delta[2-1];
  d[2][2]=delta[1-1]*delta[2-1];
  //  d[3][0]=1;
  d[3][0]=(kt[2]>0)?d[2][0]:999;
  d[3][1]= kt[3-1]>0 ? min(d[2][1],delta[3-1]*d[2][0]) :d[2][0]*delta[3-1];
  d[3][2]= kt[3-1]>0 ? min(d[2][2],delta[3-1]*d[2][1]) :d[2][1]*delta[3-1];
  d[3][3]=delta[1-1]*delta[2-1]*delta[3-1];
  //  d[4][0]=1;
  d[4][0]=(kt[3]>0)?d[3][0]:999;
  d[4][1]= kt[4-1]>0 ? min(d[3][1],delta[4-1]*d[3][0]) :d[3][0]*delta[4-1];
  d[4][2]= kt[4-1]>0 ? min(d[3][2],delta[4-1]*d[3][1]) :d[3][1]*delta[4-1];
  d[4][3]= kt[4-1]>0 ? min(d[3][3],delta[4-1]*d[3][2]) :d[3][2]*delta[4-1];
  d[4][4]=delta[1-1]*delta[2-1]*delta[3-1]*delta[4-1];
  */
  //  const int INF = 999;
  int dl[m+1][MAX_M];
  dl[1][1]=delta[0];
